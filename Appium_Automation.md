**Appium_Automation**
-----------------------------------------------------------------------------
용도: 특정 영역 자동화로 인한 휴먼 리소스 감소<br>
Inspecter 와 로컬 Appium(pm2 server)만 설치되어 있다면 누구나 접근 가능한 비상장 앱으로 진행<br> 
https://github.com/hy39094-ops/PythonProject
...
inspecter로 android uiautomator/ ID / XPath 확인
<br> 
